...
const NO_VALUE_ACTIONS = _.keys(_.pickBy(ACTIONS, (value, _) => value.value === undefined));

const actionByName = (actionName) => _.pick(ACTIONS, [actionName])[actionName];

const ACTION_OPTIONS = _.map(
  ACTIONS,
